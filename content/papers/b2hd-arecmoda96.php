...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
  ...
  <a name="top"></a>
   ...
   <div class="blogbody">
      <div class="content2">
         <h2>Modal Logic as a Software Engineering Tool</h2>
         <p class="citation">Areces, C. and Hirsch, D.. Modal Logic as a Software Engineering Tool. Universidad de Buenos Aires. Facultad de Ciencias Exactas y Naturales.	Departamento de Computaci&oacute;n, 1996.</p>
         <h4>Download: 
    <a href="files/software.pdf">
      [pdf]</a>&nbsp;</h4>
         <h4>Abstract: </h4>
         <p class="abstract">
      (unavailable)
     </p>
         <h4> BibTeX: <a href="arecmoda96.bib">
      (download)
     </a>
         </h4>
         <pre>@TECHREPORT{arec:moda96,
