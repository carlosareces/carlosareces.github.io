...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
  ...
  <a name="top"></a>
   ...
   <div class="blogbody">
      <div class="content2">
         <h2>Hybrid logic is the bounded fragment of first order logic</h2>
         <p class="citation">Areces, C., Blackburn, P., and Marx, M.. Hybrid logic is the bounded fragment of first order logic. In <i>Proceedings of 6th Workshop on Logic, Language , Information and	Computation, WOLLIC99</i>, pp. 33&ndash;50, Rio de Janeiro, Brazil, 1999.</p>
         <h4>Download: 
    <a href="files/wollic99.pdf">
      [pdf]</a>&nbsp;</h4>
         <h4>Abstract: </h4>
         <p class="abstract">
      (unavailable)
     </p>
         <h4> BibTeX: <a href="arechybr99a.bib">
      (download)
     </a>
         </h4>
         <pre>@INPROCEEDINGS{arec:hybr99a,
