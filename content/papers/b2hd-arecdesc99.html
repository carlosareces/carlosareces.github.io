...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
  ...
  <a name="top"></a>
   ...
   <div class="blogbody">
      <div class="content2">
         <h2>Description Logics and Feature Interaction</h2>
         <p class="citation">Areces, C., Bouma, W., and de Rijke, M.. Description Logics and Feature Interaction. In <i>Proceedings of the International Workshop on Description Logics (DL'99)</i>, pp. 28&ndash;32, Link&ouml;ping, Sweden, 1999.</p>
         <h4>Download: 
    <a href="files/dl-fi.pdf">
      [pdf]</a>&nbsp;</h4>
         <h4>Abstract: </h4>
         <p class="abstract">
      (unavailable)
     </p>
         <h4> BibTeX: <a href="arecdesc99.bib">
      (download)
     </a>
         </h4>
         <pre>@INPROCEEDINGS{arec:desc99,
