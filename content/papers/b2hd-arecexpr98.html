...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
  ...
  <a name="top"></a>
   ...
   <div class="blogbody">
      <div class="content2">
         <h2>Expressiveness Revisited</h2>
         <p class="citation">Areces, C. and de Rijke, M.. Expressiveness Revisited. In <i>Proceedings of the 1998 International Workshop on Description Logics	(DL'98)</i>, pp. 35&ndash;43, Trento, Italy, 1998.</p>
         <h4>Download: 
    <a href="files/10p_er.pdf">
      [pdf]</a>&nbsp;</h4>
         <h4>Abstract: </h4>
         <p class="abstract">
      (unavailable)
     </p>
         <h4> BibTeX: <a href="arecexpr98.bib">
      (download)
     </a>
         </h4>
         <pre>@INPROCEEDINGS{arec:expr98,
