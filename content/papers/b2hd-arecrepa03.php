...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
  ...
  <a name="top"></a>
   ...
   <div class="blogbody">
      <div class="content2">
         <h2>Repairing the interpolation Theorem in Quantified Modal Logic</h2>
         <p class="citation">Areces, C., Blackburn, P., and Marx, M.. Repairing the interpolation Theorem in Quantified Modal Logic. <i>Annals of Pure and Applied Logics</i>, 123(1--3):287&ndash;299, 2003.</p>
         <h4>Download: 
    <a href="files/apal03.pdf">
      [pdf]</a>&nbsp;</h4>
         <h4>Abstract: </h4>
         <p class="abstract">
      (unavailable)
     </p>
         <h4> BibTeX: <a href="arecrepa03.bib">
      (download)
     </a>
         </h4>
         <pre>@ARTICLE{arec:repa03,
