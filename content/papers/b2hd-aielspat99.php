...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
  ...
  <a name="top"></a>
   ...
   <div class="blogbody">
      <div class="content2">
         <h2>Spatial Reasoning for Image Retrieval</h2>
         <p class="citation">Aiello, M., Areces, C., and de Rijke, M.. Spatial Reasoning for Image Retrieval. In <i>Proceedings of the International Workshop on Description Logics (DL'99)</i>, pp. 23&ndash;27, Link&ouml;ping, Sweden, 1999.</p>
         <h4>Download: 
    <a href="files/dl99.pdf">
      [pdf]</a>&nbsp;</h4>
         <h4>Abstract: </h4>
         <p class="abstract">
      (unavailable)
     </p>
         <h4> BibTeX: <a href="aielspat99.bib">
      (download)
     </a>
         </h4>
         <pre>@INPROCEEDINGS{aiel:spat99,
