...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
  ...
  <a name="top"></a>
   ...
   <div class="blogbody">
      <div class="content2">
         <h2>Logic Engineering. The Case of Description and Hybrid Logics</h2>
         <p class="citation">Areces, C.. Logic Engineering. The Case of Description and Hybrid Logics. Ph.D. Thesis, Institute for Logic, Language and Computation, University of Amsterdam, Amsterdam, The Netherlands, 2000.</p>
         <h4>Download: 
    <a href="files/thesis.pdf">
      ...
      (unavailable)
         ...
         <h4> BibTeX: <a href="areclogi00.bib">
      (download)
     </a>
         </h4>
         <pre>@PHDTHESIS{arec:logi00,
  author = {Areces, C.},
