...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
  ...
  <a name="top"></a>
   ...
   <div class="blogbody">
      <div class="content2">
         <h2>Hybrid Logics</h2>
         <p class="citation">Areces, C. and ten Cate, B.. Hybrid Logics. In Blackburn, P., Wolter, F., and van Benthem, J., editors, <i>Handbook of Modal Logics</i>, pp. 821&ndash;868, Elsevier, 2006.</p>
         <h4>Download: 
    <a href="files/hml-arecestencate.pdf">
      [pdf]</a>&nbsp;</h4>
         <h4>Abstract: </h4>
         <p class="abstract">
      (unavailable)
     </p>
         <h4> BibTeX: <a href="arechybr05b.bib">
      (download)
     </a>
         </h4>
         <pre>@INCOLLECTION{arec:hybr05b,
