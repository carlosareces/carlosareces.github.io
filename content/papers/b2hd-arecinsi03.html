...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
  ...
  <a name="top"></a>
   ...
   <div class="blogbody">
      <div class="content2">
         <h2>In Situ Binding: A Hybrid Approach</h2>
         <p class="citation">Areces, C. and Bernardi, R.. In Situ Binding: A Hybrid Approach. In <i>Inference in Computational Semantics 4 - ICoS-4, Nancy, France</i>, Nancy, France, September 2003.</p>
         <h4>Download: 
    <a href="files/icos4.pdf">
      [pdf]</a>&nbsp;</h4>
         <h4>Abstract: </h4>
         <p class="abstract">Due to the concatenative interpretation of its composition operator,	the base categorial type logic \NLd encounters some difficulties	when analyzing non-concatenative material. Hence, modeling linguistic	phenomena like anaphora resolution, long distance binding, gapping,	discontinuity and quantifier raising becomes a problem in this logic.	We propose an extension of \NLd with hybrid operators (nominals and	the \,:-operator), and show that this extension has the needed expressivity	to define frame classes leading to a proper modeling of long distance	binding. We focus our presentation on the treatment of quantifier	phrases.</p>
         <h4> BibTeX: <a href="arecinsi03.bib">
      (download)
     </a>
         </h4>
         <pre>@INPROCEEDINGS{arec:insi03,
