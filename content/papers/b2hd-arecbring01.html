...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
  ...
  <a name="top"></a>
   ...
   <div class="blogbody">
      <div class="content2">
         <h2>Bringing them all together</h2>
         <p class="citation">Areces, C. and Blackburn, P.. Bringing them all together. <i>Journal of Logic and Computation</i>, 11(5):657&ndash;669, 2001.</p>
         <h4>Download: 
    <a href="files/jlc01.pdf">
      [pdf]</a>&nbsp;</h4>
         <h4>Abstract: </h4>
         <p class="abstract">
      (unavailable)
     </p>
         <h4> BibTeX: <a href="arecbring01.bib">
      (download)
     </a>
         </h4>
         <pre>@ARTICLE{arec:bring01,
