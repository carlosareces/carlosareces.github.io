  ...
  <a name="top"></a>
   ...
   <div class="blogbody">
      <div class="content2">
         ...
         <p class="citation">Areces, C. and Bernardi, R.. Analyzing the Core of Categorial Grammar. In <i>Proceedings of ICoS-3</i>, Siena, Italy, June 2001.</p>
         <h4>Download: 
    <a href="files/icos3.pdf">
      [pdf]</a>&nbsp;</h4>
         <h4>Abstract: </h4>
         <p class="abstract">
      (unavailable)
     </p>
         <h4> BibTeX: <a href="arecanal01.bib">
      (download)
     </a>
         </h4>
         <pre>@INPROCEEDINGS{arec:anal01,
