...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
  ...
  <a name="top"></a>
   ...
   <div class="blogbody">
      <div class="content2">
         <h2>Testing Provers on a Grid - Framework Description</h2>
         <p class="citation">Areces, C., Gor&iacute;n, D., Lorenzo, A., and P&eacute;rez Rodr&iacute;guez,	M.. Testing Provers on a Grid - Framework Description. In <i>Proceedings of the 22nd International Workshop on Description Logics	(DL 2009)</i>, CEUR-WS.org, 2009.</p>
         <h4>Download: 
    <a href="files/dl09.pdf">
      [pdf]</a>&nbsp;</h4>
         <h4>Abstract: </h4>
         <p class="abstract">
      (unavailable)
     </p>
         <h4> BibTeX: <a href="arectest09.bib">
      (download)
     </a>
         </h4>
         <pre>@INPROCEEDINGS{arec:test09,
