...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
  ...
  <a name="top"></a>
   ...
   <div class="blogbody">
      <div class="content2">
         <h2>Reichenbach, Prior and Montague: a semantic get-together</h2>
         <p class="citation">Areces, C. and Blackburn, P.. Reichenbach, Prior and Montague: a semantic get-together. In S. Artemov, H. Barringer, A. d'Avila Garcez, L. Lamb, and J. Woods, editors, <i>We Will Show Them: Essays in Honour of Dov Gabbay</i>, pp. 77&ndash;88, College Publications, 2005.</p>
         <h4>Download: 
    <a href="files/gabbay60.pdf">
      [pdf]</a>&nbsp;</h4>
         <h4>Abstract: </h4>
         <p class="abstract">
      (unavailable)
     </p>
         <h4> BibTeX: <a href="arecreic05.bib">
      (download)
     </a>
         </h4>
         <pre>@INCOLLECTION{arec:reic05,
