...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
  ...
  <a name="top"></a>
   ...
   <div class="blogbody">
      <div class="content2">
         <h2>Features as Constraints</h2>
         <p class="citation">Accorsi, R., Areces, C., Bouma, W., and de Rijke, M.. Features as Constraints. In <i>Proceedings of Feature Interaction Workshop (FIW'00)</i>, pp. 210&ndash;225, IOS Press, Glasgow, UK, 2000.</p>
         <h4>Download: 
    <a href="files/fas.pdf">
      [pdf]</a>&nbsp;</h4>
         <h4>Abstract: </h4>
         <p class="abstract">
      (unavailable)
     </p>
         <h4> BibTeX: <a href="accofeat00.bib">
      (download)
     </a>
         </h4>
         <pre>@INPROCEEDINGS{acco:feat00,
