...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
  ...
  <a name="top"></a>
   ...
   <div class="blogbody">
      <div class="content2">
         <h2>Iterable AGM Functions</h2>
         <p class="citation">Areces, C. and Becher, V.. Iterable AGM Functions. In H. Rott and M. Williams, editors, <i>Frontiers in Belief Revision</i>, Applied Logic Series, pp. 261&ndash;277, Kluwer Academic Publishers, 2001. Extended version of ``Iterable AGM Functions'' (Areces and Becher).</p>
         <h4>Download: 
    <a href="files/iterable.pdf">
      [pdf]</a>&nbsp;</h4>
         <h4>Abstract: </h4>
         <p class="abstract">
      (unavailable)
     </p>
         <h4> BibTeX: <a href="areciter01.bib">
      (download)
     </a>
         </h4>
         <pre>@INCOLLECTION{arec:iter01,
