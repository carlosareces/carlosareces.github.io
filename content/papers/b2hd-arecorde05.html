...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
  ...
  <a name="top"></a>
   ...
   <div class="blogbody">
      <div class="content2">
         <h2>Ordered Resolution with Selection for H(@)</h2>
         <p class="citation">Areces, C. and Gor&iacute;n, D.. Ordered Resolution with Selection for H(@). In <i>Proceedings of LPAR 2004</i>, pp. 125&ndash;141, Springer, Montevideo, Uruguay, 2005.</p>
         <h4>Download: 
    <a href="files/lpar2005.pdf">
      [pdf]</a>&nbsp;</h4>
         <h4>Abstract: </h4>
         <p class="abstract">
      (unavailable)
     </p>
         <h4> BibTeX: <a href="arecorde05.bib">
      (download)
     </a>
         </h4>
         <pre>@INPROCEEDINGS{arec:orde05,
