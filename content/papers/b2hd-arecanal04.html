...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
  ...
  <a name="top"></a>
   ...
   <div class="blogbody">
      <div class="content2">
         <h2>Analyzing the Core of Categorial Grammar</h2>
         <p class="citation">Areces, C. and Bernardi, R.. Analyzing the Core of Categorial Grammar. <i>Journal of Logic, Language and Information</i>, 13(2):121&ndash;137, 2004. Extended version of ``Analyzing the Core of Categorial Grammar''	(Areces and Bernardi).</p>
         <h4>Download: 
    <a href="files/core04.pdf">
      [pdf]</a>&nbsp;</h4>
         <h4>Abstract: </h4>
         <p class="abstract">
      (unavailable)
     </p>
         <h4> BibTeX: <a href="arecanal04.bib">
      (download)
     </a>
         </h4>
         <pre>@ARTICLE{arec:anal04,
