...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
  ...
  <a name="top"></a>
   ...
   <div class="blogbody">
      <div class="content2">
         <h2>Modal Logics with Counting</h2>
         <p class="citation">Areces, C., Hoffmann, G., and Denis, A.. Modal Logics with Counting. In <i>WoLLIC 2010 17th Workshop on Logic, Language, Information	and Computation - WoLLIC 2010 </i>, Brasilia, Brazil , 2010.</p>
         <h4>Download: 
    <a href="files/wollic10.pdf">
      [pdf]</a>&nbsp;</h4>
         <h4>Abstract: </h4>
         ...
         <h4> BibTeX: <a href="arecmoda10.bib">
      (download)
     </a>
         </h4>
         <pre>@INPROCEEDINGS{arec:moda10,
  author = {Areces, C. and Hoffmann, G. and Denis, A.},
  title = {Modal Logics with Counting},
  booktitle = {{W}o{LLIC} 2010 17th {W}orkshop on {L}ogic, {L}anguage, {I}nformation
	and {C}omputation - {W}o{LLIC} 2010 },
  year = {2010},
