...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
  ...
  <a name="top"></a>
   ...
   <div class="blogbody">
      <div class="content2">
         <h2>Completeness results for memory logics</h2>
         <p class="citation">Areces, C., Figueira, S., and Mera, S.. Completeness results for memory logics. In <i>Proceedings of LFCS'09, the Symposium on Logic Foundations of Computer	Science</i>, pp. 16&ndash;30, Deerfield Beach, Florida, USA, 2009.</p>
         <h4>Download: 
    <a href="files/lfcs09.pdf">
      [pdf]</a>&nbsp;</h4>
         <h4>Abstract: </h4>
         <p class="abstract">
      (unavailable)
     </p>
         <h4> BibTeX: <a href="areccomp09a.bib">
      (download)
     </a>
         </h4>
         <pre>@INPROCEEDINGS{arec:comp09a,
