...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
  ...
  <a name="top"></a>
   ...
   <div class="blogbody">
      <div class="content2">
         <h2>Interpolation and Bisimulation in Temporal Logic</h2>
         <p class="citation">Areces, C. and de Rijke, M.. Interpolation and Bisimulation in Temporal Logic. In <i>Proceedings of WoLLIC'98. Workshop of Logic, Language, Information	and Computation</i>, pp. 15&ndash;21, S\&nbsp;ao Paulo, Brazil, July 1998.</p>
         <h4>Download: 
    <a href="files/full_wollic.pdf">
      [pdf]</a>&nbsp;</h4>
         <h4>Abstract: </h4>
         <p class="abstract">
      (unavailable)
     </p>
         <h4> BibTeX: <a href="arecinte98b.bib">
      (download)
     </a>
         </h4>
         <pre>@INPROCEEDINGS{arec:inte98b,
