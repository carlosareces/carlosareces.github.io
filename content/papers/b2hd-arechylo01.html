...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
  ...
  <a name="top"></a>
   ...
   <div class="blogbody">
      <div class="content2">
         <h2>HyLoRes: Direct Resolution for Hybrid Logics</h2>
         <p class="citation">Areces, C. and Heguiabehere, J.. HyLoRes: Direct Resolution for Hybrid Logics. In <i>Proceedings of Methods for Modalities 2</i>, Amsterdam, The Netherlands, November 2001.</p>
         <h4>Download: 
    <a href="files/m4m02.pdf">
      [pdf]</a>&nbsp;</h4>
         <h4>Abstract: </h4>
         <p class="abstract">
      (unavailable)
     </p>
         <h4> BibTeX: <a href="arechylo01.bib">
      (download)
     </a>
         </h4>
         <pre>@INPROCEEDINGS{arec:hylo01,
