...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
  ...
  <a name="top"></a>
   ...
   <div class="blogbody">
      <div class="content2">
         <h2>From Boxes to Worlds</h2>
         <p class="citation">Areces, C. and Hirsch, D.. From Boxes to Worlds. In <i>Proceedings of the First CACiC</i>, pp. 266&ndash;276, Buenos Aires, Argentina, 1995.</p>
         <h4>Download: 
    <a href="files/cacic1995.pdf">
      [pdf]</a>&nbsp;</h4>
         <h4>Abstract: </h4>
         <p class="abstract">
      (unavailable)
     </p>
         <h4> BibTeX: <a href="arecfrom95.bib">
      (download)
     </a>
         </h4>
         <pre>@INPROCEEDINGS{arec:from95,
