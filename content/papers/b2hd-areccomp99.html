...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
  ...
  <a name="top"></a>
   ...
   <div class="blogbody">
      <div class="content2">
         <h2>The Computational Complexity of Hybrid Temporal Logics</h2>
         <p class="citation">Areces, C., Blackburn, P., and Marx, M.. The Computational Complexity of Hybrid Temporal Logics. <i>Logic Journal of the IGPL</i>, 8(5):653&ndash;679, 2000.</p>
         <h4>Download: 
    <a href="files/igpl00.pdf">
      [pdf]</a>&nbsp;</h4>
         <h4>Abstract: </h4>
         <p class="abstract">
      (unavailable)
     </p>
         <h4> BibTeX: <a href="areccomp99.bib">
      (download)
     </a>
         </h4>
         <pre>@ARTICLE{arec:comp99,
