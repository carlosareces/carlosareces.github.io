...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
  ...
  <a name="top"></a>
   ...
   <div class="blogbody">
      <div class="content2">
         <h2>Interpolation, Definability and Fixed Points in Interpretability	Logics</h2>
         <p class="citation">Areces, C., Hoogland, E., and de Jongh, D.. Interpolation, Definability and Fixed Points in Interpretability	Logics. In K. Segerberg, M. Zakharyaschev, M. de Rijke, and H. Wansing, editors, <i>Advances in Modal Logic</i>, pp. 35&ndash;58, CSLI Publications, 2000. Extended version of ``The Interpolation Theorem for IL and ILP''	(Areces, de Jongh and Hoogland).</p>
         <h4>Download: 
    <a href="files/il.pdf">
      [pdf]</a>&nbsp;</h4>
         <h4>Abstract: </h4>
      ...
      (unavailable)
         ...
         <h4> BibTeX: <a href="arecinte00.bib">
      (download)
     </a>
         </h4>
         <pre>@INCOLLECTION{arec:inte00,
