...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
  ...
  <a name="top"></a>
   ...
   <div class="blogbody">
      <div class="content2">
         <h2>The Interpolation Theorem for IL and ILP</h2>
         <p class="citation">Areces, C., de Jongh, D., and Hoogland, E.. The Interpolation Theorem for IL and ILP. In <i>Proceedings of AiML98. Advances in Modal Logic</i>, Uppsala, Sweden, October 1998.</p>
         <h4>Download: 
    <a href="files/int-il-ilp.pdf">
      [pdf]</a>&nbsp;</h4>
         <h4>Abstract: </h4>
         <p class="abstract">
      (unavailable)
     </p>
         <h4> BibTeX: <a href="arecinte98.bib">
      (download)
     </a>
         </h4>
         <pre>@INPROCEEDINGS{arec:inte98,
