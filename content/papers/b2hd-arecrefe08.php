...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
  ...
  <a name="top"></a>
   ...
   <div class="blogbody">
      <div class="content2">
         <h2>Referring Expressions as Formulas of Description Logic</h2>
         <p class="citation">Areces, C., Koller, A., and Striegnitz, K.. Referring Expressions as Formulas of Description Logic. In <i>Proceedings of the 5th International Natural Language Generation</i>, Salt Fork, OH, USA, 2008.</p>
         <h4>Download: 
    <a href="files/dl-gre-08.pdf">
      [pdf]</a>&nbsp;</h4>
         <h4>Abstract: </h4>
         <p class="abstract">
      (unavailable)
     </p>
         <h4> BibTeX: <a href="arecrefe08.bib">
      (download)
     </a>
         </h4>
         <pre>@INPROCEEDINGS{arec:refe08,
