...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
  ...
  <a name="top"></a>
   ...
   <div class="blogbody">
      <div class="content2">
         <h2>hGen: A Random CNF Formula Generator for Hybrid Languages</h2>
         <p class="citation">Areces, C. and Heguiabehere, J.. hGen: A Random CNF Formula Generator for Hybrid Languages. In <i>Methods for Modalities 3 - M4M-3, Nancy, France</i>, Nancy, France, September 2003.</p>
         <h4>Download: 
    <a href="files/m4m3.pdf">
      [pdf]</a>&nbsp;</h4>
         <h4>Abstract: </h4>
         <p class="abstract">hGen is a random CNF (conjunctive normal form) generator of formulas	for sublanguages of H(@,\downarrow, A).</p>
         <h4> BibTeX: <a href="arechgen03.bib">
      (download)
     </a>
         </h4>
         <pre>@INPROCEEDINGS{arec:hgen03,
