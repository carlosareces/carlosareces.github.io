...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
  ...
  <a name="top"></a>
   ...
   <div class="blogbody">
      <div class="content2">
         <h2>Tree-Based Heuristics in Modal Theorem Proving</h2>
         <p class="citation">Areces, C., Gennari, R., Heguiabehere, J., and de Rijke, M.. Tree-Based Heuristics in Modal Theorem Proving. In <i>Proceedings of ECAI'2000</i>, pp. 199&ndash;203, Berlin, Germany, 2000.</p>
         <h4>Download: 
    <a href="files/ecai00.pdf">
      [pdf]</a>&nbsp;</h4>
         <h4>Abstract: </h4>
         <p class="abstract">
      (unavailable)
     </p>
         <h4> BibTeX: <a href="arectree00.bib">
      (download)
     </a>
         </h4>
         <pre>@INPROCEEDINGS{arec:tree00,
