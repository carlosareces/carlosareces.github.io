...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
  ...
  <a name="top"></a>
   ...
   <div class="blogbody">
      <div class="content2">
         <h2>Concrete Domains and Nominals United</h2>
         <p class="citation">Areces, C. and Lutz, C.. Concrete Domains and Nominals United. In <i>Proceedings of HyLo@LICS</i>, Copenhagen, Denmark, July 2002.</p>
         <h4>Download: 
    <a href="files/hylo02.pdf">
      [pdf]</a>&nbsp;</h4>
         <h4>Abstract: </h4>
         <p class="abstract">
      (unavailable)
     </p>
         <h4> BibTeX: <a href="arecconc02.bib">
      (download)
     </a>
         </h4>
         <pre>@INPROCEEDINGS{arec:conc02,
