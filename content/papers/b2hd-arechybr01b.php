...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
  ...
  <a name="top"></a>
   ...
   <div class="blogbody">
      <div class="content2">
         <h2>Hybrid Logics</h2>
         <p class="citation">Areces, C. and Blackburn, P., editors. <i>Hybrid Logics</i>, Oxford University Press, October 2001.</p>
         <h4>Download: 
    <a href="files/hl-si.pdf">
      [pdf]</a>&nbsp;</h4>
         <h4>Abstract: </h4>
         <p class="abstract">
      (unavailable)
     </p>
         <h4> BibTeX: <a href="arechybr01b.bib">
      (download)
     </a>
         </h4>
         <pre>@PROCEEDINGS{arec:hybr01b,
  title = {Hybrid Logics},
  year = {2001},
