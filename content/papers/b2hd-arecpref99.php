...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
  ...
  <a name="top"></a>
   ...
   <div class="blogbody">
      <div class="content2">
         <h2>Prefixed resolution: a resolution method for modal and description	logics</h2>
         <p class="citation">Areces, C., de Nivelle, H., and de Rijke, M.. Prefixed resolution: a resolution method for modal and description	logics. In <i>Automated deduction --- CADE-16 (Trento, 1999)</i>, pp. 187&ndash;201, Springer, Berlin, Germany, 1999.</p>
         <h4>Download: 
    <a href="files/cade99.pdf">
      [pdf]</a>&nbsp;</h4>
         <h4>Abstract: </h4>
         <p class="abstract">
      (unavailable)
     </p>
         <h4> BibTeX: <a href="arecpref99.bib">
      (download)
     </a>
         </h4>
         <pre>@INPROCEEDINGS{arec:pref99,
