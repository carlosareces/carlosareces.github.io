...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
  ...
  <a name="top"></a>
   ...
   <div class="blogbody">
      <div class="content2">
         <h2>Experiments in Theorem Proving for Topological Hybrid Logic</h2>
         <p class="citation">Sustretov, D., Hoffmann, G., Areces, C., and Blackburn, P.. Experiments in Theorem Proving for Topological Hybrid Logic. In <i>Proceedings of Methods for Modalities 5</i>, November 2007.</p>
         <h4>Download: 
    <a href="files/m4m-topo.pdf">
      [pdf]</a>&nbsp;</h4>
         <h4>Abstract: </h4>
         <p class="abstract">
      (unavailable)
     </p>
         <h4> BibTeX: <a href="sustexpe07.bib">
      (download)
     </a>
         </h4>
         <pre>@INPROCEEDINGS{sust:expe07,
