...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
  ...
  <a name="top"></a>
   ...
   <div class="blogbody">
      <div class="content2">
         <h2>Hybrid logics: characterization, interpolation and complexity</h2>
         <p class="citation">Areces, C., Blackburn, P., and Marx, M.. Hybrid logics: characterization, interpolation and complexity. <i>The Journal of Symbolic Logic</i>, 66(3):977&ndash;1010, 2001.</p>
         <h4>Download: 
    <a href="files/jsl.pdf">
      [pdf]</a>&nbsp;</h4>
         <h4>Abstract: </h4>
         <p class="abstract">
      (unavailable)
     </p>
         <h4> BibTeX: <a href="arechybr01.bib">
      (download)
     </a>
         </h4>
         <pre>@ARTICLE{arec:hybr01,
