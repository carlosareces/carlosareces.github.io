  ...
  <a name="top"></a>
   ...
   <div class="blogbody">
      <div class="content2">
         ...
         <p class="citation">Areces, C., Bernardi, R., and Moortgat, M.. Galois Connections in Categorial Type Logic. In <i>Proceedings of Formal Grammar / Mathematics of Language</i>, Helsinki, Finland, August 2001.</p>
         <h4>Download: 
    <a href="files/areces-vol53.pdf">
      [pdf]</a>&nbsp;</h4>
         <h4>Abstract: </h4>
         <p class="abstract">
      (unavailable)
     </p>
         <h4> BibTeX: <a href="arecgalo01b.bib">
      (download)
     </a>
         </h4>
         <pre>@INPROCEEDINGS{arec:galo01b,
