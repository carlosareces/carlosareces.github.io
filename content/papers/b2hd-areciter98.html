  ...
  <a name="top"></a>
   ...
   <div class="blogbody">
      <div class="content2">
         ...
         <p class="citation">Areces, C. and Becher, V.. Iterable AGM Functions. In <i>Proceedings of BR'98. Belief Revision Workshop</i>, Trento, Italy, 1998.</p>
         <h4>Download: 
    <a href="files/br98.pdf">
      [pdf]</a>&nbsp;</h4>
         <h4>Abstract: </h4>
         <p class="abstract">
      (unavailable)
     </p>
         <h4> BibTeX: <a href="areciter98.bib">
      (download)
     </a>
         </h4>
         <pre>@INPROCEEDINGS{arec:iter98,
