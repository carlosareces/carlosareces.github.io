...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
  ...
  <a name="top"></a>
   ...
   <div class="blogbody">
      <div class="content2">
         <h2>HyLoRes: A Hybrid Logic Prover Based on Direct Resolution (System	Demo)</h2>
         <p class="citation">Areces, C. and Heguiabehere, J.. HyLoRes: A Hybrid Logic Prover Based on Direct Resolution (System	Demo). In <i>Proceedings of BNAIC 2002 14th Belgian-Dutch Conference on Artificial	Intelligence</i>, Leuven, Belgium, 2002.</p>
         <h4>Download: 
    <a href="files/bnaic02.pdf">
      [pdf]</a>&nbsp;</h4>
         <h4>Abstract: </h4>
         <p class="abstract">
      (unavailable)
     </p>
         <h4> BibTeX: <a href="arechylo02b.bib">
      (download)
     </a>
         </h4>
         <pre>@INPROCEEDINGS{arec:hylo02b,
