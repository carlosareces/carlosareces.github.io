...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
  ...
  <a name="top"></a>
   ...
   <div class="blogbody">
      <div class="content2">
         <h2>On the Logic For Utopia</h2>
         <p class="citation">Areces, C. and Becher, V.. On the Logic For Utopia. In <i>Annals of the 1st CACiC</i>, Bah&iacute;a Blanca, Argentina, 1995.</p>
         <h4>Download: 
    <a href="files/utopia.pdf">
      [pdf]</a>&nbsp;</h4>
         <h4>Abstract: </h4>
         <p class="abstract">In this study we propose the standard modal logic KDC4 as the logic	governing expressions about Utopia. We define a formal construction	corresponding to Utopian expressions in ordinary language that we	name utopian conditionals. They possess the singular properties of	admitting Strengthening of the Antecedent while possibly defeating	the rule of Modus Ponens. Perhaps the most interesting aspect of	this work is that, as far as the authors know, this is the first	time a category of expressions in the ordinary language corresponding	to these two singular properties is provided.</p>
         <h4> BibTeX: <a href="areclogi95.bib">
      (download)
     </a>
         </h4>
         <pre>@INPROCEEDINGS{arec:logi95,
