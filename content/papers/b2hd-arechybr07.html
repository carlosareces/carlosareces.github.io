...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
  ...
  <a name="top"></a>
   ...
   <div class="blogbody">
      <div class="content2">
         <h2>Hybrid Logics: The Old and the New</h2>
         <p class="citation">Areces, C.. Hybrid Logics: The Old and the New. In <i>Proceedigns of LogKCA-07</i>, pp. 15&ndash;29, November 2007.</p>
         <h4>Download: 
    <a href="files/logkca07.pdf">
      [pdf]</a>&nbsp;</h4>
         <h4>Abstract: </h4>
         <p class="abstract">
      (unavailable)
     </p>
         <h4> BibTeX: <a href="arechybr07.bib">
      (download)
     </a>
         </h4>
         <pre>@INPROCEEDINGS{arec:hybr07,
  author = {Areces, C.},
