...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
  ...
  <a name="top"></a>
   ...
   <div class="blogbody">
      <div class="content2">
         <h2>Controlled model exploration</h2>
         <p class="citation">Areces, C., Infante-Lopez, G., and de Rijke, M.. Controlled model exploration. In <i>Advances in Modal Logic</i>, pp. 1&ndash;16, World Scientific Publishing Co. Pte. Ltd., 2003. Extended version of ``Decomposing Modal Logic'' (Areces, Infante-Lopez	and de Rijke)</p>
         <h4>Download: 
    <a href="files/aiml02-1.pdf">
      [pdf]</a>&nbsp;</h4>
         <h4>Abstract: </h4>
         <p class="abstract">
      (unavailable)
     </p>
         <h4> BibTeX: <a href="areccont03.bib">
      (download)
     </a>
         </h4>
         <pre>@INPROCEEDINGS{arec:cont03,
