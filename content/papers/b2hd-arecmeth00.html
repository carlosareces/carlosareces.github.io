...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
  ...
  <a name="top"></a>
   ...
   <div class="blogbody">
      <div class="content2">
         <h2>Methods for Modalities 1</h2>
         <p class="citation">Areces, C., Franconi, E., Gor&eacute;, R., de Rijke, M., and Schlingloff, H., editors. <i>Methods for Modalities 1</i>, Oxford University Press, 2000. Special Issue in the Journal of the IGPL</p>
         <h4>Download: 
    <a href="files/areces00logic.pdf">
      [pdf]</a>&nbsp;</h4>
         <h4>Abstract: </h4>
         <p class="abstract">
      (unavailable)
     </p>
         <h4> BibTeX: <a href="arecmeth00.bib">
      (download)
     </a>
         </h4>
         <pre>@PROCEEDINGS{arec:meth00,
