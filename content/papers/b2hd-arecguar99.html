...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
  ...
  <a name="top"></a>
   ...
   <div class="blogbody">
      <div class="content2">
         <h2>The Guarded Fragment: Ins and Outs</h2>
         <p class="citation">Areces, C., Monz, C., de Nivelle, H., and de Rijke, M.. The Guarded Fragment: Ins and Outs. In J. Gerbrandy, M. Marx, M. de Rijke, and Y. Venema, editors, <i>JFAK. Essays Dedicated to Johan van Benthem on the Occasion of his	50th Birthday</i>, Vossiuspers, AUP, Amsterdam, 1999. Non refereed.</p>
         <h4>Download: 
    <a href="files/j50b.pdf">
      [pdf]</a>&nbsp;</h4>
         <h4>Abstract: </h4>
         <p class="abstract">
      (unavailable)
     </p>
         <h4> BibTeX: <a href="arecguar99.bib">
      (download)
     </a>
         </h4>
         <pre>@INCOLLECTION{arec:guar99,
