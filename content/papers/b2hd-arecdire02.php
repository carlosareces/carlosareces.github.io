...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
  ...
  <a name="top"></a>
   ...
   <div class="blogbody">
      <div class="content2">
         <h2>Direct Resolution for Modal-like Logics</h2>
         <p class="citation">Areces, C. and Heguiabehere, J.. Direct Resolution for Modal-like Logics. In <i>Proceedings of the 3rd International Workshop on the Implementation	of Logics</i>, pp. 3&ndash;16, Tbilisi, Georgia, 2002.</p>
         <h4>Download: 
    <a href="files/wilnew.pdf">
      [pdf]</a>&nbsp;</h4>
         <h4>Abstract: </h4>
         <p class="abstract">
      (unavailable)
     </p>
         <h4> BibTeX: <a href="arecdire02.bib">
      (download)
     </a>
         </h4>
         <pre>@INPROCEEDINGS{arec:dire02,
