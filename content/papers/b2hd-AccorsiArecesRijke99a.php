...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
  ...
  <a name="top"></a>
   ...
   <div class="blogbody">
      <div class="content2">
         <h2>An Approach to Feature Interaction via Stable Models</h2>
         <p class="citation">Accorsi, R., Areces, C., and de Rijke, M.. An Approach to Feature Interaction via Stable Models. <i>Brazilian Electronic Journal on Mathematics of Computation</i>, 1, 1999.</p>
         <h4>Download: 
    <a href="files/brazil.pdf">
      [pdf]</a>&nbsp;</h4>
         <h4>Abstract: </h4>
         <p class="abstract">
      (unavailable)
     </p>
         <h4> BibTeX: <a href="AccorsiArecesRijke99a.bib">
      (download)
     </a>
         </h4>
         <pre>@ARTICLE{AccorsiArecesRijke99a,
