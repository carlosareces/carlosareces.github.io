...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
  ...
  <a name="top"></a>
   ...
   <div class="blogbody">
      <div class="content2">
         <h2>Fragmentary Memories</h2>
         <p class="citation">Areces, C.. Fragmentary Memories. In J. Gerbrandy, M. Marx, M. de Rijke, and Y. Venema, editors, <i>JFAK. Essays Dedicated to Johan van Benthem on the Occasion of his	50th Birthday</i>, Vossiuspers, AUP, Amsterdam, 1999. Non refereed.</p>
         <h4>Download: 
    <a href="files/j50a.pdf">
      [pdf]</a>&nbsp;</h4>
         <h4>Abstract: </h4>
         <p class="abstract">
      (unavailable)
     </p>
         <h4> BibTeX: <a href="arecfrag99.bib">
      (download)
     </a>
         </h4>
         <pre>@INCOLLECTION{arec:frag99,
  author = {Areces, C.},
