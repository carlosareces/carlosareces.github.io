...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
  ...
  <a name="top"></a>
   ...
   <div class="blogbody">
      <div class="content2">
         <h2>Update, the Infinite Case</h2>
         <p class="citation">Areces, C. and Becher, V.. Update, the Infinite Case. In <i>Proceedings of WAIT'99, Argentinian Workshop on Theoretical Computer	Science</i>, Buenos Aires, Argentina, 1999.</p>
         <h4>Download: 
    <a href="files/wait99.pdf">
      [pdf]</a>&nbsp;</h4>
         <h4>Abstract: </h4>
         <p class="abstract">
      (unavailable)
     </p>
         <h4> BibTeX: <a href="arecupda99.bib">
      (download)
     </a>
         </h4>
         <pre>@INPROCEEDINGS{arec:upda99,
