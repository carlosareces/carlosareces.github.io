...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
  ...
  <a name="top"></a>
   ...
   <div class="blogbody">
      <div class="content2">
         <h2>Description and/or Hybrid Logics</h2>
         <p class="citation">Areces, C. and de Rijke, M.. Description and/or Hybrid Logics. In <i>Proceedings of AiML 2000</i>, Leipzig, Germany, 2000.</p>
         <h4>Download: 
    <a href="files/aiml2000.pdf">
      [pdf]</a>&nbsp;</h4>
         <h4>Abstract: </h4>
         <p class="abstract">
      (unavailable)
     </p>
         <h4> BibTeX: <a href="arecdesc00.bib">
      (download)
     </a>
         </h4>
         <pre>@INPROCEEDINGS{arec:desc00,
