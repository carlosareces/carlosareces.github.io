...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
  ...
  <a name="top"></a>
   ...
   <div class="blogbody">
      <div class="content2">
         <h2>A Road-map on Complexity for Hybrid Logics</h2>
         <p class="citation">Areces, C., Blackburn, P., and Marx, M.. A Road-map on Complexity for Hybrid Logics. In <i>Computer Science Logic</i>, pp. 307&ndash;321, Springer, Madrid, Spain, 1999. Proceedings of the 8th Annual Conference of the EACSL, Madrid, September	1999.</p>
         <h4>Download: 
    <a href="files/csl99_22.pdf">
      [pdf]</a>&nbsp;</h4>
         <h4>Abstract: </h4>
         <p class="abstract">
      (unavailable)
     </p>
         <h4> BibTeX: <a href="arecroad99.bib">
      (download)
     </a>
         </h4>
         <pre>@INPROCEEDINGS{arec:road99,
