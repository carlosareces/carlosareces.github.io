...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
  ...
  <a name="top"></a>
   ...
   <div class="blogbody">
      <div class="content2">
         <h2>Repairing the Interpolation Theorem in First-Order Modal Logic</h2>
         <p class="citation">Areces, C., Blackburn, P., and Marx, M.. Repairing the Interpolation Theorem in First-Order Modal Logic. In <i>Proceedings of the 16th Annual IEEE Symp.&nbsp;on Logic in Computer Science,	LICS 2001</i>, IEEE Computer Society Press, June 2001. Short Presentation</p>
         <h4>Download: 
    <a href="files/lics2001.pdf">
      [pdf]</a>&nbsp;</h4>
         <h4>Abstract: </h4>
         <p class="abstract">
      (unavailable)
     </p>
         <h4> BibTeX: <a href="arecrepa01a.bib">
      (download)
     </a>
         </h4>
         <pre>@INPROCEEDINGS{arec:repa01a,
