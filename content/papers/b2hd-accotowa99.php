...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
  ...
  <a name="top"></a>
   ...
   <div class="blogbody">
      <div class="content2">
         <h2>Towards Feature Interaction via Stable Models</h2>
         <p class="citation">Accorsi, R., Areces, C., and de Rijke, M.. Towards Feature Interaction via Stable Models. In <i>Proceedings of the 2nd WFM</i>, Florian&oacute;polis, Brasil, October 1999.</p>
         <h4>Download: 
    <a href="files/wmf99_submit.pdf">
      [pdf]</a>&nbsp;</h4>
         <h4>Abstract: </h4>
         <p class="abstract">
      (unavailable)
     </p>
         <h4> BibTeX: <a href="accotowa99.bib">
      (download)
     </a>
         </h4>
         <pre>@INPROCEEDINGS{acco:towa99,
