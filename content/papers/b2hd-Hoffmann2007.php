...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
  ...
  <a name="top"></a>
   ...
   <div class="blogbody">
      <div class="content2">
         <h2>HTab: A Terminating Tableaux System for Hybrid Logic</h2>
         <p class="citation">Hoffmann, G. and Areces, C.. HTab: A Terminating Tableaux System for Hybrid Logic. <i>Electronic Notes in Theoretical Computer Science</i>, 231:3&ndash;19, Elsevier, March 2009. Proceedings of Methods for Modalities 5</p>
         <h4>Download: 
    <a href="files/htabM4M.pdf">
      [pdf]</a>&nbsp;</h4>
         <h4>Abstract: </h4>
         <p class="abstract">
      (unavailable)
     </p>
         <h4> BibTeX: <a href="Hoffmann2007.bib">
      (download)
     </a>
         </h4>
         <pre>@ARTICLE{Hoffmann2007,
