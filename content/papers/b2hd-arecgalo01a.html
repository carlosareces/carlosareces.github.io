...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
  ...
  <a name="top"></a>
   ...
   <div class="blogbody">
      <div class="content2">
         <h2>Galois connections in categorial type logic</h2>
         <p class="citation">Areces, C., Bernardi, R., and Moortgat, M.. Galois connections in categorial type logic. <i>Electronic Notes in Theoretical Computer Science</i>, 53:3&ndash;20, 2001. Extended version of FGMOL'01 paper of the same title.</p>
         <h4>Download: 
    <a href="files/entcs01.pdf">
      [pdf]</a>&nbsp;</h4>
         <h4>Abstract: </h4>
         <p class="abstract">
      (unavailable)
     </p>
         <h4> BibTeX: <a href="arecgalo01a.bib">
      (download)
     </a>
         </h4>
         <pre>@ARTICLE{arec:galo01a,
