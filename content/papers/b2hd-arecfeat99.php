...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
  ...
  <a name="top"></a>
   ...
   <div class="blogbody">
      <div class="content2">
         <h2>Feature Interaction as a Satisfiability Problem</h2>
         <p class="citation">Areces, C., Bouma, W., and de Rijke, M.. Feature Interaction as a Satisfiability Problem. In <i>Proceedings of <i>MASCOTS'99</i></i>, pp. 339&ndash;346, IEEE Computer Society, Los Alamitos, California, October 1999.</p>
         <h4>Download: 
    <a href="files/fi-mascots.pdf">
      [pdf]</a>&nbsp;</h4>
         <h4>Abstract: </h4>
         <p class="abstract">
      (unavailable)
     </p>
         <h4> BibTeX: <a href="arecfeat99.bib">
      (download)
     </a>
         </h4>
         <pre>@INPROCEEDINGS{arec:feat99,
