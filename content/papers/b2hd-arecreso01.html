...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
  ...
  <a name="top"></a>
   ...
   <div class="blogbody">
      <div class="content2">
         <h2>Resolution in Modal, Description and Hybrid Logic</h2>
         <p class="citation">Areces, C., de Nivelle, H., and de Rijke, M.. Resolution in Modal, Description and Hybrid Logic. <i>Journal of Logic and Computation</i>, 11(5):717&ndash;736, 2001.</p>
         <h4>Download: 
    <a href="files/preamble-areces.pdf">
      [pdf]</a>&nbsp;</h4>
         <h4>Abstract: </h4>
         <p class="abstract">
      (unavailable)
     </p>
         <h4> BibTeX: <a href="arecreso01.bib">
      (download)
     </a>
         </h4>
         <pre>@ARTICLE{arec:reso01,
