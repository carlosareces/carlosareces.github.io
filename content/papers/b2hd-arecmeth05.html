...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
  ...
  <a name="top"></a>
   ...
   <div class="blogbody">
      <div class="content2">
         <h2>Methods for Modalities 3</h2>
         <p class="citation">Areces, C., editors. <i>Methods for Modalities 3</i>, Elsevier, 2005. Special Issue in the Journal of Applied Logics</p>
         <h4>Download: 
    <a href="files/m4m-3.pdf">
      [pdf]</a>&nbsp;</h4>
         <h4>Abstract: </h4>
         <p class="abstract">
      (unavailable)
     </p>
         <h4> BibTeX: <a href="arecmeth05.bib">
      (download)
     </a>
         </h4>
         <pre>@PROCEEDINGS{arec:meth05,
