  ...
  <a name="top"></a>
   ...
   <div class="blogbody">
      <div class="content2">
         ...
         <p class="citation">Areces, C., Becher, V., and Ferro, S.. Characterization Results for d-Horn Formulas. In <i>Proceedings of ITALLC'98. Information Theoretic Approaches to Logic,	Language and Computation</i>, Hsi-Tow, Taiwan, 1998.</p>
         <h4>Download: 
    <a href="files/itallc98.pdf">
      [pdf]</a>&nbsp;</h4>
         <h4>Abstract: </h4>
         <p class="abstract">
      (unavailable)
     </p>
         <h4> BibTeX: <a href="arecchar98.bib">
      (download)
     </a>
         </h4>
         <pre>@INPROCEEDINGS{arec:char98,
