...
<div class="blog">
  ...
  <div class="blogbody">
  <ul>
    <li><a href="../esslli15/index.php">ESSLLI15</a></li>
    <li><a href="../nasslli10/index.php">NASSLLI10</a></li>
    <li><a href="../cordoba08/index.php">Cordoba08</a></li>
    <li><a href="../esslli08/index.php">ESSLLI08</a></li>
    <li><a href="../ls/index.php">Logics and Statistics for Language Modeling: Logic Section</a></li>
    <li><a href="../mi/index.php">Mathematics for Informatics</a></li>
    <li><a href="../LMC/index.html" target="_top">L&oacute;gica Modal Computacional<a></li>
      </ul>
